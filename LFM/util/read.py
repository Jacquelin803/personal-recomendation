...
if __name__=='__main__':
    #item_dict=get_item_info('/Users/jacquelin/PycharmProjects/untitled10/movies.txt')
    #print(len(item_dict))
    #print (item_dict['1'])
    #print(item_dict['11'])

    #score_dict=get_ave_score('/Users/jacquelin/PycharmProjects/untitled10/ratings.txt')
    #print(len(score_dict))
    #print(score_dict['1'])
    train_data = get_train_data('/Users/jacquelin/PycharmProjects/LFM_2/data/ratings.txt')
    print(len(train_data))
    print(train_data[80:100])
